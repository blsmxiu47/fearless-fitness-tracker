...
export default function Sidebar() {
    ...
    return (
        <>
        <nav className="fixed top-0 z-50 w-full bg-[var(--theme-light-bg-2)] border-b border-gray-200 dark:bg-[var(--theme-dark-bg-2)] dark:border-gray-700">
                ...
                <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center">
                        <div className="flex items-center ms-3">
                            <div>
                                <button type="button" id="user-menu-button" className="flex text-sm bg-[var(--theme-light-bg-2)] dark:bg-[var(--theme-dark-bg-2)] rounded-full focus:outline-none focus:ring-2 focus:ring-[var(--accent-1)]" aria-expanded="true" aria-haspopup="true" onClick={() => setUserMenu(!userMenu)}>
        ...
        <aside className={`fixed top-0 left-0 z-40 h-full pt-20 bg-[var(--theme-light-bg-2)] border-r border-gray-200 duration-200 sm:translate-x-0 dark:bg-[var(--theme-dark-bg-2)] dark:border-gray-700 ${isSidebarOpen ? "w-64" : "-left-10 sm:left-0 w-0 sm:w-16"}`} aria-label="Sidebar">
            ...
            <div className={`h-full pt-2 px-3 pb-4 overflow-y-hidden bg-[var(--theme-light-bg-2)] dark:bg-[var(--theme-dark-bg-2)] ${isSidebarOpen ? "block" : "hidden sm:block"}`}>
                <ul className="font-medium">
                    <li className="py-2">
                        <Link href="/dashboard" className="flex items-center p-2 rounded-lg text-[var(--theme-light-text-2)] dark:text-[var(--theme-dark-text-2)] hover:bg-gray-100 dark:hover:bg-gray-700 group focus:outline-none focus:ring-2 focus:ring-[var(--accent-1)]">
                    ...
                    <li className="py-2">
                        <a href="/my-sessions" className="flex items-center p-2 rounded-lg text-[var(--theme-light-text-2)] dark:text-[var(--theme-dark-text-2)] hover:bg-gray-100 dark:hover:bg-gray-700 group focus:outline-none focus:ring-2 focus:ring-[var(--accent-1)]">
                    ...
                    <li className="py-2">
                        <a href="/calendar" className="flex items-center p-2 rounded-lg text-[var(--theme-light-text-2)] dark:text-[var(--theme-dark-text-2)] hover:bg-gray-100 dark:hover:bg-gray-700 group focus:outline-none focus:ring-2 focus:ring-[var(--accent-1)]">
                    ...
                    <li className="py-2">
                        <a href="/build-routine" className="flex items-center p-2 rounded-lg text-[var(--theme-light-text-2)] dark:text-[var(--theme-dark-text-2)] hover:bg-gray-100 dark:hover:bg-gray-700 group focus:outline-none focus:ring-2 focus:ring-[var(--accent-1)]">
                    ...
                    <li className="py-2">
                        <a href="/explore" className="flex items-center p-2 rounded-lg text-[var(--theme-light-text-2)] dark:text-[var(--theme-dark-text-2)] hover:bg-gray-100 dark:hover:bg-gray-700 group focus:outline-none focus:ring-2 focus:ring-[var(--accent-1)]">
                    ...
                    <li className="py-2">
                        <a href="/reports" className="flex items-center p-2 rounded-lg text-[var(--theme-light-text-2)] dark:text-[var(--theme-dark-text-2)] hover:bg-gray-100 dark:hover:bg-gray-700 group focus:outline-none focus:ring-2 focus:ring-[var(--accent-1)]">
                    ...
                    {/* <li>
                        <a href="/preferences" className="flex items-center p-2 rounded-lg text-[var(--theme-light-text-2)] dark:text-[var(--theme-dark-text-2)] hover:bg-gray-100 dark:hover:bg-gray-700 group focus:outline-none focus:ring-2 focus:ring-[var(--accent-1)]">
                    ...
                    <li className="py-2">
                        <a href="/import-data" className="flex items-center p-2 rounded-lg text-[var(--theme-light-text-2)] dark:text-[var(--theme-dark-text-2)] hover:bg-gray-100 dark:hover:bg-gray-700 group focus:outline-none focus:ring-2 focus:ring-[var(--accent-1)]">
